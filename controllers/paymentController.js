...
export const buySubscription = catchAsyncError(async(req, res, next) => {
    ...
    const plan_id = process.env.PLAN_ID || "plan_Ladedgh97aOcyq";
...
export const cancelSubscription = catchAsyncError(async(req, res, next) => {
    ...
    res.status(200).json({
        success: true,
        message: refund ? "Subscription cancelled, You Will Receive full refund with in 7 days" : "Subscription cancelled, You will not receive any refund, Subscription cancel initiated after 7 Days.",
